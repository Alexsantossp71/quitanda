...
class CartController extends GetxController {
  ...
  /// INICIO MUDA QUANTIDADE DO PRODUTO
  ...
  Future<bool> changeItemQuantity({
    ...
    if (result) {
      ...
      utilsServices.showToast(
        message: 'Erro ao alterar a quantidade',
        isError: true,
      );
    }
  ...
  /// FIM MUDA QUANTIDADE DE PRODUTO

  /// INICIO CONSTROE LISTA DE PRODUTOS.
  ...
  /// FIM CONSTROE LISTA DE PRODUTOS.
  ///
  /// INICIO PROCURA ID DO PRODUTO
  int getItemIndex(ItemModel item) {
    return cartItems.indexWhere((itemInList) => itemInList.item.id == item.id);
  }

// FIM PROCURA ID DO PRODUTO
...
// alterando a quantidade do produto
      ...
      result.when(success: (cartItemId) {
        ...
        utilsServices.showToast(message: mesage, isError: true);
      });
    }
    update();
  } //fim do addItemToCart adiciono produto
}
